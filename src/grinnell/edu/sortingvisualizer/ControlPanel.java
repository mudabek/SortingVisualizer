	...
	public ControlPanel(NoteIndices notes, ArrayPanel panel) {
		...
		playButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Integer[] copyInd = Arrays.copyOf(indices, indices.length);

				List<SortEvent<Integer>> events = generateEvents((String) sorts.getSelectedItem(), copyInd);
				...
				timer.schedule(new TimerTask() {
					...
					public void run() {
						...
						if (index < events.size()) {
							...
							//got help from Thao Linh Pham and Jae Eun Oh
